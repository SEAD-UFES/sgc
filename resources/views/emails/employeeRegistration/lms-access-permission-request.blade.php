@php
$article = $employeeGender === 'Masculino' ? 'o' : 'a';
@endphp
@component('mail::message')
Prezada Equipe DEDI,

A pedido da Coordenação do **Curso de {{ $courseName }}**, venho solicitar a liberação de acesso d{{ $article }} colaborador{{ $employeeGender === 'Masculino' ? '' : 'a' }} abaixo mencionad{{ $article }} às salas das disciplinas deste referido curso.
