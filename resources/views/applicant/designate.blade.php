            ...
            <div class="row justify-content-center">
                <div class="col-xl-10 col-xxl-8">
                    ...
                    <form action={{ route('employees.store') }} name="formCreate" method="POST">
                        ...
                        'maritalStatuses', 'addressStates', 'employee', 'fromApplicant'))@endcomponent
                        <input type="hidden" name="importDocuments" id="importDocuments" value="false" />
                        <br />
                        <button type="submit" class="btn btn-primary">Cadastrar</button>
                        <button type="button" onclick="submitAndImport();" class="btn btn-primary">Cadastrar e importar documentos</button>
