...
<div class="mb-3">
    ...
    <input name="name" type="text" id="inputName1" class="form-control" placeholder="Nome" value="{{ $employee->name ?? old('name') }}"
        maxlength="50" />
    @error('name')
...
<div class="mb-3">
    ...
    <input name="cpf" id="cpf" type="text" id="inputCpf1" class="form-control" placeholder="CPF" value="{{ $employee->cpf ?? old('cpf') }}"
...
<div class="mb-3">
    ...
    <input name="job" type="text" id="inputJob1" class="form-control" placeholder="Profissão" value="{{ $employee->job ?? old('job') }}"
        maxlength="50" />
    @error('job')
        <div class="error">> {{ $message }}</div>
    @enderror
...
<div class="mb-3">
    <label for="inputBirthday1" class="form-label">Data de Nascimento</label>
    <input name="birthday" type="date" id="inputBirthday1" value="{{ $employee->birthday ?? old('birthday') }}" class="form-control" />
    @error('birthday')
        <div class="error">> {{ $message }}</div>
    @enderror
</div>
<div class="mb-3">
    <label for="selectBirthState1" class="form-label">UF Nascimento</label>
...
<div class="mb-3">
    <label for="inputId1" class="form-label">Número do Documento</label>
...
<div class="mb-3">
    ...
    <input name="addressPostalCode" id="addressPostalCode" type="text" id="inputPostal1" class="form-control" placeholder="CEP"
...
<div class="mb-3">
    <label for="inputArea1" class="form-label">Código de Área</label>
    <input name="areaCode" id="areaCode" type="text" id="inputArea1" class="form-control" placeholder="Código"
...
<div class="mb-3">
    ...
    <input name="phone" id="phone" type="text" id="inputPhone1" class="form-control" placeholder="Telefone"
...
<div class="mb-3">
    ...
    <input name="mobile" id="mobile" type="text" id="inputMobile1" class="form-control" placeholder="Celular"
